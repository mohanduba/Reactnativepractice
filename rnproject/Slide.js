        ...
        <View style={{ flexDirection: "row", gap: 2 }}>
          ...
          >
            <FontAwesome
              ...
              style={{
                color: "white",
                backgroundColor: color ? "rgba(128,128,128,1)" : "grey",
                padding: 8,
                width: 24,
                height: "24",
                borderRadius: 50,
          ...
          renderItem={({ item }) => (
            <View
              style={{
                ...
                padding: 8,
                borderRadius: 5,
                borderColor: "#6d6d6d4f",
                marginBottom: 30,
              }}
            >
              <View
                style={{ flexDirection: "row-reverse", marginBottom: "20%" }}
              >
                <Entypo name="star" size={20} style={{ color: "orange" }} />
              </View>
              <View style={{ alignItems: "center", paddingBottom: 30 }}>
                <Image source={item.image} style={{ width: 66, height: 66 }} />
                <Text style={{ marginBottom: 8, fontSize: 22 }}>
                  {item.name}
                </Text>
                <Text style={{ fontSize: 14, color: "#808080d6" }}>
                  {item.email}
                </Text>
                <Text style={{ fontSize: 14, color: "#808080d6" }}>
                  {item.location}
